# Django settings for pdfdummy project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dummy.sqlite3',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'someverysekretkeyavailablepubliclyisabadidea'
...
WSGI_APPLICATION = 'pdfdummy.wsgi.application'
...
WETO_LIB_PATH = '/usr/bin/wkhtmltopdf'
WETO_OPTS = ["--dpi",
            "600",
            "--page-size",
            "A4"]